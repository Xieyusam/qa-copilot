...
async def test_copilot_service_records_trace():
    ...
    mock_llm = MagicMock()
    mock_llm.chat = AsyncMock(return_value="qa")  # Mock the chat method used in intent classification
    ...
    # Mock database
    with patch("app.services.core.copilot_service.SessionLocal") as mock_session_local:
        mock_db = MagicMock()
